...
resource "aws_iam_role_policy_attachment" "ecs_agent-ssm-core" {
  role       = aws_iam_role.ecs_agent.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonSSMManagedInstanceCore"
}

resource "aws_iam_role_policy_attachment" "ecs_agent-ssm-patch" {
  role       = aws_iam_role.ecs_agent.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonSSMPatchAssociation"
}

resource "aws_iam_role_policy_attachment" "ecs_agent-custom-policy" {
  role       = aws_iam_role.ecs_agent.name
